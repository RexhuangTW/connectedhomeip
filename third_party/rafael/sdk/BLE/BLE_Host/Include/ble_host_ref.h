...
#define NUM_QUEUE_HCI_ACL_DATA_TX 32
...
#define NUM_QUEUE_HOST_TO_APP_EVENT 16
...
extern uint32_t param_host_timer[NUM_LL_LINK][REF_SIZE_CMDTMR >>
                                              2]; /**< A predefined and reserved block of memory used for the BLE host timers. */
extern hci_acl_data_reassemble reassemble_acl_data[NUM_LL_LINK]; /**< A predefined and reserved block of memory used for the BLE HCI
                                                                    to reassemble incomplete ACL packets. */
extern uint8_t param_host_identity[BLE_SUPPORT_NUM_CONN_MAX]
                                  [22]; /**< A predefined and reserved block of memory used for the BLE Identity fuction. */
/** @} */
