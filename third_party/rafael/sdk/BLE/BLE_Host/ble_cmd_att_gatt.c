...
ble_err_t ble_cmd_suggest_data_len_set(uint16_t tx_octets)
{
    ...
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_gatt_suggested_data_len_param_t));
...
ble_err_t ble_cmd_default_mtu_size_set(uint8_t host_id, uint16_t mtu)
{
    ...
    status = BLE_ERR_OK;
    // set preferred MTU size
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_gatt_mtu_param_t));
...
ble_err_t ble_cmd_data_len_update(uint8_t host_id, uint16_t tx_octets)
{
    ...
    status = BLE_ERR_OK;
    // set preferred data length
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_gatt_data_len_param_t));
...
ble_err_t ble_cmd_mtu_size_get(uint8_t host_id, uint16_t * mtu)
{
    ...
    status = BLE_ERR_OK;
    // set preferred MTU size
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_gatt_get_mtu_param_t));
...
ble_err_t ble_cmd_gatt_read_req(ble_gatt_read_req_param_t * p_param)
{
    ...
    status    = BLE_ERR_OK;
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_gatt_read_req_param_t));
    if (p_ble_tlv != NULL)
    {
...
ble_err_t ble_cmd_gatt_read_blob_req(ble_gatt_read_blob_req_param_t * p_param)
{
    ...
    status    = BLE_ERR_OK;
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_gatt_read_blob_req_param_t));
    if (p_ble_tlv != NULL)
    {
