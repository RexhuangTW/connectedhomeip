...
ble_err_t ble_cmd_adv_param_set(ble_adv_param_t * p_param)
{
    ...
    status = BLE_ERR_OK;
    // adv parameter set
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_adv_param_t));
...
ble_err_t ble_cmd_adv_data_set(ble_adv_data_param_t * p_param)
{
    ...
    status = BLE_ERR_OK;
    // adv data set
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_adv_data_param_t));
...
ble_err_t ble_cmd_adv_enable(uint8_t host_id)
{
    ...
    status    = BLE_ERR_OK;
    p_ble_tlv = sys_malloc(sizeof(ble_tlv_t) + sizeof(ble_adv_enable_param_t));
