...
link_info_t link_info[LINK_NUM] =
{
    ...
    1, BLE_GATT_ROLE_SERVER,
    2, BLE_GATT_ROLE_SERVER,
    3, BLE_GATT_ROLE_SERVER,
    4, BLE_GATT_ROLE_CLIENT,
    5, BLE_GATT_ROLE_CLIENT,
    6, BLE_GATT_ROLE_CLIENT,
    7, BLE_GATT_ROLE_CLIENT,
};
...
ble_att_handle_param_t att_hdl_para_links01[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Server
ble_att_handle_param_t att_hdl_para_links02[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 2 Server
ble_att_handle_param_t att_hdl_para_links03[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 3 Server
ble_att_handle_param_t att_hdl_para_linkc04[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 4 Client
ble_att_handle_param_t att_hdl_para_linkc05[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 5 Client
ble_att_handle_param_t att_hdl_para_linkc06[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 6 Client
ble_att_handle_param_t att_hdl_para_linkc07[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 7 Client
...
const ble_att_db_mapping_by_id_t att_db_mapping[] =
{
    ...
    {
        ((ble_att_handle_param_t *)0),     // Client Link Parameter
        att_hdl_para_links02,              // Server Link Parameter
    },
    // Link 3
    {
        ((ble_att_handle_param_t *)0),     // Client Link Parameter
        att_hdl_para_links03,              // Server Link Parameter
    },
    // Link 4
    {
        att_hdl_para_linkc04,              // Client Link Parameter
        ((ble_att_handle_param_t *)0),     // Server Link Parameter
    },
    // Link 5
    {
        att_hdl_para_linkc05,              // Client Link Parameter
        ((ble_att_handle_param_t *)0),     // Server Link Parameter
    },
    // Link 6
    {
        att_hdl_para_linkc06,              // Client Link Parameter
        ((ble_att_handle_param_t *)0),     // Server Link Parameter
    },
    // Link 7
    {
        att_hdl_para_linkc07,              // Client Link Parameter
        ((ble_att_handle_param_t *)0),     // Server Link Parameter
    },
};
