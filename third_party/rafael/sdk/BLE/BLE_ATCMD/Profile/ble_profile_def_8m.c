...
{
    0, BLE_GATT_ROLE_CLIENT,
    1, BLE_GATT_ROLE_CLIENT,
    2, BLE_GATT_ROLE_CLIENT,
    3, BLE_GATT_ROLE_CLIENT,
...
*/
ble_att_handle_param_t att_hdl_para_linkc00[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc01[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc02[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc03[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc04[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc05[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc06[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
ble_att_handle_param_t att_hdl_para_linkc07[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 1 Client
...
const ble_att_db_mapping_by_id_t att_db_mapping[] =
{
    ...
    // Link 3
    {
        att_hdl_para_linkc03,              // Client Link Parameter
        ((ble_att_handle_param_t *)0),     // Server Link Parameter
    },
    // Link 4
    {
