...
ble_att_handle_param_t att_hdl_para_links01[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 0 Server
ble_att_handle_param_t att_hdl_para_links02[SIZE_ARRAY_ROW(att_service_comb00)]; // Link 0 Server
