...
static int8_t hci_le_connection_complete_evnet(uint8_t * p_data)
{
    ...
    if (p_queue_param != NULL)
    {
        ...
        case BLE_HCI_ERR_CODE_SUCCESS:
            ...
            memcpy(p_evt_param->event_param.ble_evt_gap.param.evt_conn_complete.peer_addr.addr, p_conn_complete->peer_addr,
                   BLE_ADDR_LEN);
...
static int8_t hci_le_connection_update_complete_event(uint8_t * p_data)
{
    ...
    if (p_queue_param != NULL)
    {
        ...
        if (p_conn_updata_complete->status == BLE_HCI_ERR_CODE_SUCCESS)
        {
            ...
            p_evt_param->event_param.ble_evt_gap.param.evt_conn_param_update.periph_latency =
                p_conn_updata_complete->periph_latency;
...
static int8_t hci_le_remote_connection_parameter_request_event(uint8_t * p_data)
{
    ...
    if ((p_para_req->min_interval < BLE_CONN_INTERVAL_MIN || p_para_req->min_interval > BLE_CONN_INTERVAL_MAX) ||
        ...
        (p_para_req->min_interval > p_para_req->max_interval) || (p_para_req->max_latency > BLE_CONN_LATENCY_MAX) ||
...
static int8_t hci_command_complete_event(uint8_t * p_data, uint8_t length)
{
    ...
    case GET_OPCODE(HCI_CMD_INFO_PARAM, INFO_PARAM_READ_LOCAL_VERSION_INFO):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param.evt_read_local_ver, &p_cmd_cmp->para.read_local_ver,
                   sizeof(ble_hci_return_param_read_local_ver_t));
    ...
    case GET_OPCODE(HCI_CMD_STATUS_PARAM, STATUS_PARAM_READ_RSSI):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_gap.param.evt_rssi.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.read_rssi.handle);
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_EVENT_MASK):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param.evt_set_event_mask, &p_cmd_cmp->para.set_event_mask,
                   sizeof(ble_hci_return_param_set_event_mask_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_READ_BUFFER_SIZE):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param.evt_read_buffer_size, &p_cmd_cmp->para.read_buffer_size,
                   sizeof(ble_hci_return_param_read_buffer_size_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_RANDOM_DEVICE_ADDRESS):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_gap.param.evt_set_addr, &p_cmd_cmp->para.set_random_addr,
                   sizeof(ble_hci_return_param_set_random_addr_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_ADVERTISING_PARAMETERS):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_adv.param.evt_set_adv_param, &p_cmd_cmp->para.set_adv_param,
                   sizeof(ble_hci_return_param_set_adv_param_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_ADVERTISING_DATA):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_adv.param.evt_set_adv_data, &p_cmd_cmp->para.set_adv_data,
                   sizeof(ble_hci_return_param_set_adv_data_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_SCAN_RSP_DATA):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_adv.param.evt_set_scan_rsp, &p_cmd_cmp->para.set_scan_rsp,
                   sizeof(ble_hci_return_param_set_scan_rsp_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_ADVERTISING_ENABLE):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_adv.param.evt_set_adv_enable, &p_cmd_cmp->para.set_adv_enable,
                   sizeof(ble_hci_return_param_set_adv_enable_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_SCAN_PARAMETERS):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_scan.param.evt_set_scan_param, &p_cmd_cmp->para.set_scan_param,
                   sizeof(ble_hci_return_param_set_scan_param_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_SCAN_ENABLE):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_scan.param.evt_set_scan_enable, &p_cmd_cmp->para.set_scan_enable,
                   sizeof(ble_hci_return_param_set_scan_enable_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_CREATE_CONNECTION_CANCEL):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_gap.param, &p_cmd_cmp->para.create_conn_cancel,
                   sizeof(ble_hci_return_param_create_conn_cancel_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_READ_FILTER_ACCEPT_LIST_SIZE):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param, &p_cmd_cmp->para.read_accept_list_size,
                   sizeof(ble_evt_common_read_filter_accept_list_size_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_CLEAR_FILTER_ACCEPT_LIST):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param, &p_cmd_cmp->para.clear_accept_list,
                   sizeof(ble_evt_common_clear_filter_accept_list_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_ADD_DEVICE_TO_FILTER_ACCEPT_LIST):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param, &p_cmd_cmp->para.add_accept_list,
                   sizeof(ble_hci_return_param_add_accept_list_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_REMOVE_DEVICE_FROM_FILTER_ACCEPT_LIST):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param, &p_cmd_cmp->para.remove_accept_list,
                   sizeof(ble_hci_return_param_remove_accept_list_t));
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_READ_PHY):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_gap.param.evt_phy.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.read_phy.conn_handle);
            ...
            task_host_queue_send(TASK_HOST_QUEUE_TO_APP, p_queue_param);
            BLE_PRINTF(BLE_DEBUG_CMD_INFO, "[BLE_EVT] tx phy%d rx phy%d\n", p_cmd_cmp->para.read_phy.tx_phy,
                       p_cmd_cmp->para.read_phy.rx_phy);
        }
        else
        {
            status = ERR_MEM;
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_WRITE_SUGGESTED_DEFAULT_DATA_LENGTH): {
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_att_gatt.param.ble_evt_suggest_data_length_set.status =
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_READ_CHANNEL_MAP):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_gap.param.evt_channel_map.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.read_channel_map.conn_handle);
            p_evt_param->event_param.ble_evt_gap.param.evt_channel_map.status = p_cmd_cmp->para.read_channel_map.status;
            memcpy(&p_evt_param->event_param.ble_evt_gap.param.evt_channel_map.channel_map[0],
                   p_cmd_cmp->para.read_channel_map.channel_map, 5);
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_CONNECTION_CTE_RECEIVE_PARAMETERS):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_cte.param.evt_conn_cte_rx_param.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.set_cte_rx_param.conn_handle);
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_SET_CONNECTION_CTE_TRANSMIT_PARAMETERS):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_cte.param.evt_conn_cte_tx_param.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.set_cte_tx_param.conn_handle);
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_CONNECTION_CTE_REQUEST_ENABLE):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_cte.param.evt_conn_cte_req.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.set_cte_req.conn_handle);
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_CONNECTION_CTE_RESPONSE_ENABLE):
        ...
        if (p_queue_param != NULL)
        {
            ...
            p_evt_param->event_param.ble_evt_cte.param.evt_conn_cte_rsp.host_id =
                bhc_query_host_id_by_conn_id(p_cmd_cmp->para.set_cte_rsp.conn_handle);
    ...
    case GET_OPCODE(HCI_CMD_LE_CONTROLLER_CMD, LE_READ_ANTENNA_INFORMATION):
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param.evt_read_antenna_info.status,
                   &p_cmd_cmp->para.read_antenna_info.status, sizeof(ble_hci_return_param_read_antenna_info_t));
...
static int8_t hci_command_status_event(uint8_t * p_data, uint8_t length)
{
    ...
    default:
        BLE_PRINTF(BLE_DEBUG_CMD_INFO, "[BLE_EVT] unknow cmd status %d, HCI_Ogf 0x%x, HCI_Ocf 0x%x\n", p_cmd_status->status,
                   p_cmd_status->ogf, p_cmd_status->ocf);
        break;
    }
...
static int8_t hci_le_meta_event(uint8_t * p_data, uint8_t length)
{
    ...
    {
        return prcss_le_meta_event[((ble_hci_le_meta_evt_t *) p_data)->subevent_code](
            (uint8_t *) &((ble_hci_le_meta_evt_t *) p_data)->para);
    }
    else
    {
        return ERR_OK;
...
int8_t prcss_hci_vendor_event(uint8_t * p_data, uint8_t length)
{
    ...
    case HCI_SUBEVENT_VENDOR_SCAN_REQUEST_REPORT: {
        ...
        if (p_queue_param != NULL)
        {
            ...
            memcpy(&p_evt_param->event_param.ble_evt_common.param.evt_scan_req_rpt.addr_type, &p_vendor_param->addr_type,
                   sizeof(ble_evt_vendor_scan_req_rpt_t));
