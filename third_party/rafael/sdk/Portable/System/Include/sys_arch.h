...
sys_queue_t sys_queue_static_new(uint32_t queue_length, uint32_t item_size, uint8_t * pucQueueStorageBuffer,
...
sys_task_t sys_task_static_new(sys_thread_fn thread, const char * name, void * arg, uint32_t u32_stacksize, uint32_t u32_priority,
