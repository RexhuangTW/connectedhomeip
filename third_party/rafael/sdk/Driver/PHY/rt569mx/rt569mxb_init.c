...
#define RF_PMU_PARA_VER                     (25)
#define HAL_ZERO_IF_EN                      (1)

#if ((RF_PMU_PARA_VER > 20) && (RF_MCU_PATCH_SUPPORTED == 0))
#error "RF_PMU_PARA_VER is larger than 20, need to enable RF_MCU_PATCH_SUPPORTED"
#endif
...
#define EXT_HAL_MEM_EN                      (EXT_HAL_MEM_EN_FW_CFG|EXT_HAL_MEM_EN_HW_CFG|EXT_HAL_MEM_EN_DFT_TAB_RF|EXT_HAL_MEM_EN_DFT_TAB_PMU|EXT_HAL_MEM_EN_HW_PARA|EXT_HAL_MEM_EN_HW_TAB|EXT_HAL_MEM_EN_REG_PATCH)
...
#define HAL_MANUAL_CFG                      (HAL_MANUAL_DIO|HAL_MANUAL_TEMP_MEAS|HAL_MANUAL_VDD_MEAS)
...
#if (RF_PMU_PARA_VER >= 19)     /* 20221111 */
#define HAL_REG_PATCH_EN                    (HAL_REG_PATCH_EN_HAL_INIT_BLE)
#else
...
#if (RF_PMU_PARA_VER >= 23)     /* 20230203 */
        BYTE_INV_U16(0x0000),                           // Gaussian filter type
#elif (RF_PMU_PARA_VER >= 22)   /* 20221227 */
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
        BYTE_INV_U16(0x0000),                           // Gaussian filter type
#else
        BYTE_INV_U16(0x0001),                           // Gaussian filter type
#endif
#elif (RF_PMU_PARA_VER >= 19)   /* 20221111 */
        BYTE_INV_U16(0x0000),                           // Gaussian filter type
#else
        BYTE_INV_U16(0x0001),                           // Gaussian filter type
#endif
...
const uint8_t extHalMemDftTabRf[] =
{
    ...
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0xdf, 0x70, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x5a, // 0x30
    0x28, 0xc0, 0x0b, 0x06, 0x8e, 0xc0, 0xf3, 0x20, 0x2c, 0x80, 0x72, 0x3c, 0x00, 0x90, 0x00, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x20, 0x13, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x13, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x04, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x31, // 0x90
    ...
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0x8e, 0xf1, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x5a, // 0x30
    0x28, 0xc0, 0x0b, 0x02, 0x8e, 0xc0, 0xb3, 0x20, 0x2c, 0x80, 0x12, 0x3c, 0x02, 0x74, 0x80, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x20, 0x13, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x23, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x07, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
...
#elif (RF_PMU_PARA_VER >= 20)     /* 20221114, 20221121 */
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    0x00, 0x00, 0x62, 0x90, 0xd1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x75, 0x72, 0x01, 0xbd, 0x10, 0x00, // 0x00
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x50, 0x00, 0x3d, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    ...
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x50, 0x00, 0x3d, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0x8f, 0xf1, 0x07, 0xa2, 0x07, 0x44, 0x80, 0x5a, // 0x30
    0x28, 0xc0, 0x0b, 0x02, 0x8e, 0xc0, 0xb3, 0x20, 0x2c, 0x80, 0x12, 0x3c, 0x03, 0x74, 0x80, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x20, 0x1b, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x23, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x07, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x31, // 0x90
    ...
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    0x00, 0x00, 0x62, 0x90, 0xd1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x75, 0x72, 0x01, 0xbd, 0x10, 0x00, // 0x00
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x50, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0xdf, 0x70, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x5a, // 0x30
    0x28, 0xc0, 0x0b, 0x06, 0x8e, 0xc0, 0xf3, 0x20, 0x2c, 0x80, 0x72, 0x3c, 0x00, 0x90, 0x00, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x20, 0x13, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
...
#elif (RF_PMU_PARA_VER == 18)     /* 20221017 */
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    0x00, 0x00, 0x62, 0x90, 0xd1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x75, 0x72, 0x01, 0xbd, 0x10, 0x00, // 0x00
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x50, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0xdf, 0x70, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x5a, // 0x30
    0x28, 0xc0, 0x1b, 0x06, 0x8e, 0xc0, 0xf3, 0x20, 0x2c, 0x80, 0x72, 0x3c, 0x00, 0x90, 0x00, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x20, 0x13, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x13, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x04, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
    ...
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0x8f, 0xf1, 0x07, 0xa2, 0x07, 0x44, 0x80, 0x5a, // 0x30
    0x28, 0xc0, 0x1b, 0x02, 0x8e, 0xc0, 0xb3, 0x20, 0x2c, 0x80, 0x12, 0x3c, 0x03, 0x74, 0x80, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x20, 0x1b, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x23, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x07, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
...
#elif (RF_PMU_PARA_VER == 17)     /* 20221006 */
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    0x00, 0x00, 0x62, 0x90, 0xd1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x75, 0x72, 0x01, 0xbd, 0x10, 0x00, // 0x00
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x40, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0xdf, 0x70, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x56, // 0x30
    0x28, 0xc0, 0x1b, 0x06, 0x8e, 0xc0, 0xf3, 0x20, 0x2c, 0x80, 0x72, 0x3c, 0x00, 0x90, 0x00, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x30, 0x03, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x13, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x04, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x31, // 0x90
    ...
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x40, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0x8f, 0xf1, 0x07, 0xa2, 0x07, 0x44, 0x80, 0x56, // 0x30
    0x28, 0xc0, 0x1b, 0x06, 0x8e, 0xc0, 0xb3, 0x20, 0x2c, 0x80, 0x12, 0x3c, 0x03, 0x74, 0x80, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x30, 0x0b, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x23, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x07, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x31, // 0x90
...
#elif (RF_PMU_PARA_VER == 16)     /* 20220928 */
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    0x00, 0x00, 0x62, 0x90, 0xd1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x75, 0x72, 0x01, 0xbd, 0x10, 0x00, // 0x00
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x40, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0xdf, 0x70, 0x07, 0xa2, 0x07, 0x44, 0x80, 0x56, // 0x30
    ...
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x40, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0x8f, 0xf1, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x56, // 0x30
    0x28, 0xc0, 0x1b, 0x06, 0x8e, 0xc0, 0xb3, 0x20, 0x2c, 0x80, 0x12, 0x3c, 0x03, 0x74, 0x80, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x30, 0x03, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x14, 0x14, 0x14, 0x09, // 0x50
    0x22, 0x12, 0x00, 0x00, 0x08, 0x0a, 0x03, 0xff, 0x19, 0x0d, 0x04, 0x08, 0x23, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x0e, 0x01, 0x0d, 0x70, 0x00, 0xf2, 0xf2, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
...
const uint8_t extHalMemDftTabPmu[] =
{
...
#else
#if (RF_PMU_PARA_VER >= 17)     /* 20221006, 20221017, 20221111, 20221114, 20221121 */
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    // 0x00
    ...
    0x77, 0x77, 0xF7, 0x00, 0x77, 0x77, 0x00, 0x00, 0x06, 0x60, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xBB, 0x8B, 0x10, 0x10, 0x10, 0x10, 0x3F, 0x0F, // 0x90
    0x3A, 0xBB, 0x4D, 0x70, 0x3D, 0xBD, 0x69, 0x70, 0x00, 0xFF, 0x00, 0xFF, 0x7E, 0x3A, 0xD9, 0xC0, // 0xA0
    0x0E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0xB0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0xC0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0xD0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0xE0
...
const  sHAL_HW_TAB_IND extHalMemHwTab =
{
    ...
    {BYTE_INV_U8(0x06),     BYTE_INV_U8(0x06),      BYTE_INV_U8(0x06)},
#else
    {BYTE_INV_U8(0x02),     BYTE_INV_U8(0x02),      BYTE_INV_U8(0x02)},
#endif
#else
    {BYTE_INV_U8(0x05),     BYTE_INV_U8(0x05),      BYTE_INV_U8(0x02)},
#endif
    // rfTabRxFiltVcm
...
const sHAL_REG_PATCH_DATA extHalMemRegPatchMem0[] =
{
    ...
    // {BYTE_INV_U16(0x0122),  BYTE_INV_U8(0x3),   BYTE_INV_U8(0x5),   BYTE_INV_U8(0x07)},
    {BYTE_INV_U16(0x0206),  BYTE_INV_U8(0x0),   BYTE_INV_U8(0x7),   BYTE_INV_U8(0x14)},
};
...
{
    {0x0098, {0x03, 0x00, 0xFF, 0x00}},
    {0x009C, {0x03, 0x00, 0x00, 0x00}},
    {0x00A0, {0xA1, 0x8B, 0x40, 0x71}},
    {0x00C0, {0x12, 0xF0, 0x2F, 0x00}},
    {0x00C4, {0x12, 0xF0, 0x2A, 0x00}},
};
