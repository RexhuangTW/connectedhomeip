...
static const size_t mem_HeapStructSize =
...
static void * _mem_malloc(size_t WantedSize)
{
...
#endif
    {
        ...
        if ((WantedSize & mem_BlockAllocatedBit) == 0)
        {
            ...
            if ((WantedSize > 0) && ((WantedSize + mem_HeapStructSize) > WantedSize)) /* Overflow check */
            {
                ...
                if ((WantedSize & portBYTE_ALIGNMENT_MASK) != 0x00)
                {
                    ...
                    if ((WantedSize + (portBYTE_ALIGNMENT - (WantedSize & portBYTE_ALIGNMENT_MASK))) > WantedSize)
                    {
