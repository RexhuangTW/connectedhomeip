...
#define FOTA_UPDATE_BUFFER_FW_ADDRESS_1MB       0x0007C000          /**< Address of FOTA update data.*/
#define SIZE_OF_FOTA_BANK_1MB                   0x74000             /**< Total Size for saving FOTA update data.*/

#define FOTA_UPDATE_BUFFER_FW_ADDRESS_512K      0x00041000          /**< Address of FOTA update data.*/
#define SIZE_OF_FOTA_BANK_512K                  0x39000             /**< Total Size for saving FOTA update data.*/

#define FOTA_IMAGE_READY                        0xA55A6543          /**< Specific string for notify bootloader that bank1 exist image ready to update.*/

typedef uint32_t fotabnak_status;
...
typedef struct
{
    fotabnak_status     status;                 /* Two possible results for Bank 1: already programming, erase failure */
