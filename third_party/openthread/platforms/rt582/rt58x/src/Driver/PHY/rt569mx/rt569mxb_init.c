...
#define EXT_HAL_MEM_ADDR_FW_CFG             (0x1030)
#define EXT_HAL_MEM_ADDR_HW_CFG             (0x1044)
#define EXT_HAL_MEM_ADDR_DFT_TAB_MDM        (0x10B4)
#define EXT_HAL_MEM_ADDR_DFT_TAB_RF         (0x1124)
#define EXT_HAL_MEM_ADDR_DFT_TAB_PMU        (0x1214)
#define EXT_HAL_MEM_ADDR_BMU_MEM_HWRXQ      (0x1310)
#define EXT_HAL_MEM_ADDR_BMU_MEM_HWSWRXQ    (0x1318)
#define EXT_HAL_MEM_ADDR_HW_PARA            (0x1324)
#define EXT_HAL_MEM_ADDR_HW_TAB             (0x13D8)
#define EXT_HAL_MEM_ADDR_PRTCL_CFG          (0x14E0)
#define EXT_HAL_MEM_ADDR_REG_PATCH          (0x1508)
...
#define HAL_REG_PATCH_EN_REG_RESTORE        (0x1000)
#define HAL_REG_PATCH_EN_TX_EN              (0x2000)
#define HAL_REG_PATCH_EN_RX_EN              (0x4000)
...
#define PHY_TAB_VAL_BLE_PKT_SYNC_BIT_TH_1M                  (32)
#define PHY_TAB_VAL_BLE_PKT_SYNC_BIT_TH_2M                  (40)
...
#define PHY_TAB_VAL_BLE_PKT_SYNC_CORR_TH_1M                 (800)
...
#define HALPHY_RFK_PARA_RX_TIADC_RX_BW_SEL                  (0x05)
#define HALPHY_RFK_PARA_RX_TIADC_TX_BW_SEL                  (15)
#define HALPHY_RFK_PARA_RX_TIADC_IF_SEL                     (3)
...
const uint8_t extHalMemDftTabRf[] =
{
...
#else
#if (RF_PMU_PARA_VER == 9)
#if (RF_TX_POWER_TYPE == RF_TX_POWER_0DBM)
    /*  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F */
    0x00, 0x00, 0x62, 0x90, 0xd1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x75, 0x72, 0x01, 0xbd, 0x10, 0x00, // 0x00
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x40, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0xdf, 0x70, 0x07, 0xa2, 0x07, 0x44, 0x80, 0x25, // 0x30
    0x28, 0xc0, 0x1b, 0x06, 0x8e, 0xc0, 0xf3, 0x20, 0x2c, 0x80, 0x72, 0x3c, 0x03, 0x90, 0x00, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x00, 0x0b, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x1d, 0x10, 0x0b, 0x04, // 0x50
    ...
    0x00, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x00, 0x40, 0x00, 0x15, 0x08, 0x00, 0x0f, 0x0f, 0x0f, 0x03, // 0x10
    0x07, 0x15, 0x81, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0xca, 0x19, 0x76, // 0x20
    0x3a, 0xff, 0xfe, 0x00, 0xe7, 0x7d, 0x00, 0x00, 0x8f, 0xf1, 0x07, 0xa3, 0x07, 0x44, 0x80, 0x4f, // 0x30
    0x28, 0xc0, 0x1b, 0x06, 0x8e, 0xc0, 0xb3, 0x20, 0x2c, 0x80, 0x12, 0x3c, 0x03, 0x74, 0x80, 0x00, // 0x40
    0xc3, 0xdc, 0x03, 0x00, 0x03, 0x20, 0x00, 0x80, 0x80, 0x0e, 0x00, 0x00, 0x1d, 0x10, 0x0b, 0x04, // 0x50
    0x57, 0x11, 0x00, 0x00, 0x10, 0x0c, 0x02, 0xff, 0x0f, 0x0a, 0x04, 0x08, 0x23, 0x11, 0x00, 0x00, // 0x60
    0x10, 0x05, 0x02, 0x0f, 0x40, 0x00, 0xf7, 0xf3, 0x0b, 0xf2, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, // 0x70
    0x95, 0x07, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x31, // 0x90
    0x00, 0x41, 0xa0, 0x10, 0x00, 0x00, 0x00, 0x00, 0x3b, 0x00, 0x00, 0x00, 0xf1, 0xff, 0xee, 0x77, // 0xA0
    0xd9, 0xee, 0xfe, 0x00, 0xf9, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x32, 0x14, 0x1f, // 0xB0
    0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x17, 0x00, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, // 0xC0
    0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x17, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, // 0xD0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0xE0
#endif
...
const uint8_t extHalMemDftTabPmu[] =
{
    ...
    0x77, 0x77, 0xF7, 0x00, 0x77, 0x77, 0x00, 0x00, 0x06, 0x60, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, // 0x80
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xBB, 0x8B, 0x04, 0x04, 0x04, 0x04, 0x3F, 0x0F, // 0x90
    0x3A, 0xBB, 0x4D, 0x70, 0x3D, 0xB5, 0x69, 0x70, 0x00, 0xFF, 0x00, 0xFF, 0x7E, 0x3A, 0xD9, 0xC1, // 0xA0
...
#endif
    BYTE_INV_U8(RF_TAB_RSSI_OFFSET_DEFAULT),                        // rssiOffset
...
const  sHAL_HW_TAB_IND extHalMemHwTab =
{
...
#if (RF_MCU_CHIP_TYPE == RF_MCU_TYPE_FPGA_RFT3)
    // rfTabTxBw
    {BYTE_INV_U8(0x0A),     BYTE_INV_U8(0x06),      BYTE_INV_U8(0x06)},
    // rfTabRxBw
    {BYTE_INV_U8(0x06),     BYTE_INV_U8(0x05),      BYTE_INV_U8(0x05)},
    // rfTabRxIf
    {BYTE_INV_U8(0x05),     BYTE_INV_U8(0x03),      BYTE_INV_U8(0x03)},
#else
    // rfTabTxBw
    {BYTE_INV_U8(0x0F),     BYTE_INV_U8(0x0D),      BYTE_INV_U8(0x0D)},
    // rfTabRxBw
    {BYTE_INV_U8(0x02),     BYTE_INV_U8(0x01),      BYTE_INV_U8(0x01)},
    // rfTabRxIf
    ...
    {BYTE_INV_U8(0x01),     BYTE_INV_U8(0x00),      BYTE_INV_U8(0x00)},
    // rfTabRxFiltPw
    {BYTE_INV_U8(0x04),     BYTE_INV_U8(0x02),      BYTE_INV_U8(0x02)},
    // rfTabRxFiltVcm
    {BYTE_INV_U8(0x01),     BYTE_INV_U8(0x01),      BYTE_INV_U8(0x01)},
    // rfTabRxFiltCcomp
    {BYTE_INV_U8(0x04),     BYTE_INV_U8(0x03),      BYTE_INV_U8(0x03)},
    // rfTabVgaOpComp
    {BYTE_INV_U8(0x00),     BYTE_INV_U8(0x00),      BYTE_INV_U8(0x00)},
    // rfTabRxVgaPw
    {BYTE_INV_U8(0x04),     BYTE_INV_U8(0x02),      BYTE_INV_U8(0x02)},
#endif
#endif
    ...
    {BYTE_INV_U8(0x01),     BYTE_INV_U8(0x02),     BYTE_INV_U8(0x04)},
#endif
    ...
    {BYTE_INV_U8(0x03),     BYTE_INV_U8(0x05),     BYTE_INV_U8(0x06)},
    // phyTabRxTrackingKq[IDX_MAX]
    {BYTE_INV_U8(0x01),     BYTE_INV_U8(0x04),     BYTE_INV_U8(0x05)},
    ...
    {BYTE_INV_U8(0x02),     BYTE_INV_U8(0x01),     BYTE_INV_U8(0x02)},
#endif
#if (HAL_CLK_CFG & HAL_32M_CLK_SUPPORT)
    ...
    {BYTE_INV_U8(0x03),     BYTE_INV_U8(0x04),     BYTE_INV_U8(0x02)},
    // phyTabTxTail[IDX_MAX]
    {BYTE_INV_U8(0x00),     BYTE_INV_U8(0x01),     BYTE_INV_U8(0x02)},
#if (HAL_CFG & (HAL_BLE_SUPPORT|HAL_WISUN_SUPPORT))
    // phyTabRxPathDelayFsk[IDX_MAX]
    {BYTE_INV_U8(0x07),     BYTE_INV_U8(0x09),     BYTE_INV_U8(0x00)},
#endif
#if (HAL_CFG & HAL_BLE_SUPPORT)
...
#endif
#if (HALRF_CFG & HALRF_SUBG_SUPPORT)
    // phyTabLNAGainSubG[PHY_TAB_LNA_GAIN_LEN]
#endif
    // phyTabTIAGain[PHY_TAB_TIA_GAIN_LEN]
    {0x00, 0x05, 0x0C, 0x11, 0x11, 0x16, 0x19, 0x1E, 0x25, 0x2B, 0x32, 0x38, 0x3E, 0x45, 0x4B, 0x52},
...
const sHAL_REG_PATCH extHalMemRegPatch =
{
    ...
    /* Patch memory info. */
    {
        ...
        {BYTE_INV_U16(EXT_HAL_MEM_ADDR_REG_PATCH_MEM12_START),  BYTE_INV_U16(EXT_HAL_MEM_ADDR_REG_PATCH_MEM12_END)},    // mem[12]: REG_PATCH_REG_RESTORE
        {BYTE_INV_U16(EXT_HAL_MEM_ADDR_REG_PATCH_MEM13_START),  BYTE_INV_U16(EXT_HAL_MEM_ADDR_REG_PATCH_MEM13_END)},    // mem[13]: REG_PATCH_TX_EN
        {BYTE_INV_U16(EXT_HAL_MEM_ADDR_REG_PATCH_MEM14_START),  BYTE_INV_U16(EXT_HAL_MEM_ADDR_REG_PATCH_MEM14_END)},    // mem[13]: REG_PATCH_RX_EN
    }
};
