...
*************************************************************************************************/
/**
 * @brief Set Crypto accelerator to load AES encryption/decryption algorithm.
 *
 * @param[in]  None
 *
 ...
 *           Crypto accelerator supports encryption and decryption switch without requiring re-initial firmware again.
 *           But when system uses crypto acclelerator to do other algorithm, like ECC, the
 *           system should load the ECC crypto algorithm to do that specified operation.
 *           After that, if system wants to use crypto accelerator to do aes operation again,
 *           system should call aes_fw_init() function to load AES algorithm again.
 *
 */

extern void aes_fw_init(void);
